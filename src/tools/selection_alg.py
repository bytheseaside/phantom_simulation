...
Usage:
  python selection_alg.py --matrix F.npy --algorithm condition --min-cols 6 --out results/
  python selection_alg.py --matrix F.npy --names e1 e2 e3 e4 e5 e6 e7 e8 e9 --algorithm correlation
  python selection_alg.py --matrix F.npy --algorithm qr --min-cols 8
